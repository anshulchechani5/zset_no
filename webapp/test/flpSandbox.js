					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Set Number Change",
									"targetURL": "#zsetnumber-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"zsetnumber-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zsetnumber",
									"url": sap.ui.require.toUrl("zsetnumber")
								}
							}
						}
					}
